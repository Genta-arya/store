<div class="container">
	<h1 class="well">
		<center>Pendaftaran MiiStore</center>
	</h1>
	<div class="col-lg-12 well">
        ...
        Pendaftaran berhasil! Silakan <a href='../index.php?p=login' class='btn btn-danger'>Masuk</a> untuk melanjutkan.
      </div>";
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="fname" placeholder="Masukan isi nama Anda"
						...
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="lname" placeholder="Masukan isi nama Anda"
					...
					<div class="row">
						<div class="col-sm-12 form-group">
							<label>Alamat :</label>
							<input type="text" class="form-control" name="address" placeholder="Masukan isi alamat"
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="city"
								placeholder="Masukan isi nama kota atau kabupaten"
						...
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="state" placeholder="Masukan isi provinsi"
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="postcode" placeholder="Masukan isi kode pos"
						...
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="phone" maxlength="14"
								placeholder="Masukan isi nomor telepon Anda" value="+62">
							<span class="text-danger msg-error">
								<?php echo $phoneErr; ?>
							</span>
						</div>
					...
					<div class="row">
						<div class="col-sm-4 form-group">
							...
							<input type="text" class="form-control" name="email" placeholder="Masukan isi alamat email"
					...
					<center>
						<div class="form-group">
							<div class="checkboxcss"><input type="checkbox" name="agree" value="1"> Saya setuju akan
								siap mengikut aturan ini</div>
							<span class="text-danger msg-error">
								<?php echo $agreeErr; ?>
							</span>
						</div>
	...
	<div class="well">
		<p class="text-center new-account">Pernah jadi anggota? <a href="../index.php?p=login">Masuk</a></p>
	</div>
</div>